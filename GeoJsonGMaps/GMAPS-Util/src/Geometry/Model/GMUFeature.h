...
@property(nonatomic, nullable, readonly) NSString *svg;
@property(nonatomic, nullable, readonly) NSArray *southWest;
@property(nonatomic, nullable, readonly) NSArray *northEast;
@property(nonatomic, nullable, readonly) NSNumber *bearing;

/**
 * The properties of the geometry in the feature.
 */
@property(nonatomic, nullable, readonly) NSDictionary<NSString *, id> *properties;
